...
function setCookie(key, value, expiredays) {
	key = document.getElementById("js_userid"); 
...
    return key.test(document.cookie) ? unescape(RegExp.$1) : ''; // 인자로 받은 키에 해당하는 키가 있으면 참/거짓 값을 반환
}
 
//쿠키 체크 - 있으면 true 없으면 false, getCookie() 에 의존
